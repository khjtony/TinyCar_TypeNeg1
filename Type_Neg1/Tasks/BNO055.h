...
bool  BNO_055_begin               ( adafruit_bno055_opmode_t mode, I2C_HandleTypeDef*, uint8_t);
void  BNO_055_setMode             ( adafruit_bno055_opmode_t mode );
void  BNO_055_getRevInfo          ( adafruit_bno055_rev_info_t* );
void  BNO_055_displayRevInfo      ( void );
void  BNO_055_setExtCrystalUse    ( bool usextal );
void  BNO_055_getSystemStatus     ( uint8_t *system_status,
                            uint8_t *self_test_result,
                            uint8_t *system_error);
void  BNO_055_displaySystemStatus ( void );
void  BNO_055_getCalibration      ( uint8_t* system, uint8_t* gyro, uint8_t* accel, uint8_t* mag);
...
void  BNO_055_printSensor ( UART_HandleTypeDef* );
void  BNO_055_readSensor(UART_HandleTypeDef*);
